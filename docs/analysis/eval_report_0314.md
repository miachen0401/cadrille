...
t=0 (greedy): @1=@4=@16 (all samples identical).

| Model | @1 t=0 | @1 t=0.3 | @4 t=0.3 | @16 t=0.3 | @1 t=0.7 | @4 t=0.7 | @16 t=0.7 | @1 t=1.0 | @4 t=1.0 | @16 t=1.0 |
|---|---|---|---|---|---|---|---|---|---|---|
| sft        | 0.847 | 0.842 | 0.881 | 0.908 | 0.821 | 0.904 | 0.909 | 0.792 | 0.893 | 0.907 |
| official-rl| **0.907** | 0.884 | 0.901 | 0.908 | 0.900 | 0.910 | **0.914** | 0.900 | 0.912 | **0.921** |
...
t=0 (greedy): pass@k = pass@1 for all k (deterministic).

| Model | @1 t=0 | @1 t=0.3 | @4 t=0.3 | @16 t=0.3 | @1 t=0.7 | @4 t=0.7 | @16 t=0.7 | @1 t=1.0 | @4 t=1.0 | @16 t=1.0 |
|---|---|---|---|---|---|---|---|---|---|---|
| sft        | 0.440 | 0.444 | 0.460 | 0.460 | 0.439 | 0.474 | 0.500 | 0.419 | 0.485 | 0.520 |
| official-rl| **0.540** | **0.504** | **0.521** | 0.540 | **0.522** | **0.539** | 0.540 | **0.504** | **0.541** | **0.560** |
